...
_OAUTH_SERVICES = {
    ...
    "outlook": {
        "endpoint": "/api/oauth/microsoft/authorize",
        "label": "Microsoft (Outlook, Calendar, To Do, OneDrive)",
    },
    "outlook-calendar": {
        "endpoint": "/api/oauth/microsoft/authorize",
        "label": "Microsoft (Outlook, Calendar, To Do, OneDrive)",
...
def connect_account(
    ...
    print("\033[90mOpening browser for OAuth authorization.\033[0m")
...
def list_accounts(
    ...
    print("\033[1mConnected accounts:\033[0m\n")
